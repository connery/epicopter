...
void processLedStatus() {
  ...
  #if defined (UseGPS) // process ready state light in case we use GPS
  ...
  #if defined (BattMonitor) // process ready state light in case we use Batt monitor
  ...
  if (flightMode == ATTITUDE_FLIGHT_MODE) // process mode light
    {
