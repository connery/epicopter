...
*/
    //m2_ui->label_3->setPixmap(QPixmap(getCurrentDir()+"/data/2015_new_logo_epicopter_white.png"));
...
void Login::on_Login_customContextMenuRequested(const QPoint &pos)
{
